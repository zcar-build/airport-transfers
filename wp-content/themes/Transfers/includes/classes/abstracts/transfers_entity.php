<?php
/**
 * Abstract TF Entity Class
 *
 * The Transfers entity class handles individual entity data.
 *
 * @class 		transfers_entity
 * @package		Transfers/Abstracts
 * @category	Abstract Class
 * @author 		Transfers
 */
 if (!class_exists('transfers_entity')) { 
	 abstract class transfers_entity {
		 ...
		 *
		 * @access public
		 * @param int|transfers_entity|WP_Post $entity Entity ID, post object, or entity object
		 */
		public function __construct( $entity, $entity_type ) {
			...
			} elseif ( $entity instanceof transfers_entity ) {
		...
		private function get_prefix($use_prefix) {
			return $use_prefix ? '_' . $this->entity_type . '_' : '';
		}
		...
		public function get_permalink() {
			return apply_filters( 'transfers_entity_permalink', $this->post ? get_permalink( $this->id ) : '', $this );
		}
		...
		public function get_id() {
			return apply_filters( 'transfers_entity_id', $this->post ? $this->id : null, $this );
		}
		...
		public function get_base_id() {
			return apply_filters( 'transfers_entity_base_id', $this->post ? transfers_get_default_language_post_id($this->post->ID, $this->entity_type ) : null, $this );
		}
		...
		public function get_title() {
			return apply_filters( 'transfers_entity_title', $this->post ? $this->post->post_title : '', $this );
		}
		...
		public function get_description() {
			...
			return apply_filters( 'transfers_entity_description', $description, $this );
		}
		...
		public function get_excerpt() {
			...
			return apply_filters( 'transfers_entity_description', $text, $this );
		}
		...
		public function get_content() {
			...
			return apply_filters( 'transfers_entity_content', $content, $this );
		}
		 ...
		 * @return string
		 */
		public function get_main_image($image_size = TRANSFERS_THUMB_IMAGE_SIZE) {
			$featured_image = '';
			...
			return apply_filters( 'transfers_entity_featured_image', $featured_image, $this );
		}	
		...
		public function get_parent() {
			return apply_filters( 'transfers_entity_parent', absint( $this->post->post_parent ), $this );
		}
