...
<table class="widefat" cellspacing="0">
	<thead>
		<tr>
			<th colspan="2"><h2><img src="<?php echo plugins_url('../images/techgasp-minilogo-16.png', __FILE__); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;About', 'google_analytics_master'); ?></h2></th>
		</tr>
	</thead>
	...
	<tbody>
		<tr class="alternate">
			<td><img src="<?php echo plugins_url('../images/techgasp-googleanalyticsmaster-logo.png', __FILE__); ?>" alt="<?php echo get_option('google_analytics_master_name'); ?>" align="left" width="387px" height="171px" style="padding:5px;"/></td>
			<td>
