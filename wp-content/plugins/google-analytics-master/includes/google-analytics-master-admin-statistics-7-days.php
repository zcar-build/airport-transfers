<?php
// Create menu
function menu_single_google_analytics_admin_statistics_7_days(){
	if ( is_admin() )
	add_submenu_page( 'google-analytics-master', 'Statistics 7 Days', 'Statistics 7 Days', 'manage_options', 'google-analytics-master-admin-statistics-7-days', 'google_analytics_master_admin_statistics_7_days' );
}

function google_analytics_master_admin_statistics_7_days(){
?>
<div class="wrap">
  ...
  <ul class="FlexGrid FlexGrid--halves">
    <li class="FlexGrid-item">
        <header class="Titles">
          ...
          <div class="Titles-sub">Last 7 days</div>
        </header>
...
if( is_multisite() ) {
add_action( 'admin_menu', 'menu_single_google_analytics_admin_statistics_7_days' );
}
else {
add_action( 'admin_menu', 'menu_single_google_analytics_admin_statistics_7_days' );
}
