...
Plugin Name:  inSite by Duda: Personalization Made Easy
...
Donate Link: http://www.dudamobile.com

Increase conversions with actions (popups, notification bars and more) set off by triggers (time, date, etc.) that you define. 

== Description ==

inSite is a personalization tool based on triggers and actions that enables you to personalize your website for every visitor easily and quickly. You’ll be able to deliver targeted messages to each and every website visitor. 

Choose from any of the following triggers - or a combination of these triggers - to initiate the action: time of day, date, location, number of previous visits, and more. You can also create your own custom trigger in JavaScript. After you choose your trigger, select the action that will occur. You can choose from ready-made actions including popups, notification bars, and new site row, or create your own action.

For more details, see our video: https://vimeo.com/126690533 or learn more here: https://www.dudamobile.com/insite

inSites take just 5 minutes to build (no coding required!) and can increase conversions by as much as 70%. "inSites have helped me make my site more engaging and personalized. The options for customization are limitless, so I can target my users almost one-by-one!" 

Here are a few ideas for integrating inSites into your website: 
...
Like tinkering with code? You can create a completely unique inSite by writing your own custom JavaScript trigger and action.
...
2. Choose a trigger to set an action
...
= 1.6.9 =
* Bug fixes
* Fixed security vulnerabilities disclosed by Zach Julian - http://www.zjulian.com/
...
= 1.6.4 =
* Duplicate inSite - Now you can create similar inSites using different triggers, or  customize what you already built without creating it again. Check it out in “My inSite” tab. 
* Bug fixes
...
= 1.6.2 =
* Referrer trigger - Want to display custom messages to visitors coming from different sites? This is for you!
* Improve short code capabilities
* Bug fixings in new elements layout and more 
...
= 1.5.2 =
* Login with the same user to different sites or WordPress installation
* Choose a specific page to display your custom made JavaScript action
* Clearer preview display
* Some bug fixes
...
= 1.6.2 =
* Upgrade to customize your site using the new referrer trigger. Update Now!
...
= 1.5.2 =
* Upgrade to support login using the same user to a few site and installations.
