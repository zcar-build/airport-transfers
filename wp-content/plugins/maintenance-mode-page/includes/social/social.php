...
<!---------------------------------------->
	<?php $wpsm_mmr_plugin_options_social = unserialize(get_option('wpsm_mmr_plugin_options_social'));	
	?>	
	<style>
	...
	<div class="row">
						...
						<div class="post-social post-social-xs" id="post-social-5">
							<div class="text-center padding-all text-center">
								<div class="textbox text-white   margin-bottom settings-title">
									<?php _e('Social Settings','WPSM_MMR_TEXT_DOMAIN'); ?>
								</div>
							</div>
						</div>
					</div>
		...
		<form method="post" id="wpsm_mmr_plugin_options_social" >
			...
			<div class="panel panel-primary panel-default content-panel">
				<div class="panel-body">
					<table class="form-table">
						<tr>
							<th scope="row" ><?php _e('Social Profiles','WPSM_MMR_TEXT_DOMAIN')?></th>
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td>
								<h4><a href="http://wpshopmart.com/plugins/coming-soon-pro/" target="_blank">Unlock More 10+ Social Profiles with Drag And Drop Position Feature In pro version </a></h4>
							</td>
						</tr>
					</table>
				</div>
		...
		<div class="panel panel-primary save-button-block">
			<div class="panel-body">
				<div class="pull-left">
					<button type="button" class="btn btn-info btn-lg" onclick="wpsm_mmr_option_data_save('social')"><?php _e('Save Changes','WPSM_MMR_TEXT_DOMAIN'); ?></button>
				</div>
				<div class="pull-right">
					<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_mmr_option_data_reset('social')"><?php _e('Reset Default','WPSM_MMR_TEXT_DOMAIN'); ?></button>
				</div>
			</div>
		</div>
