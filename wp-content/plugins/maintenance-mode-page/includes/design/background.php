...
<!----------------------------------------> 
<?php $wpsm_mmr_plugin_options_background = unserialize(get_option('wpsm_mmr_plugin_options_background'));	
?>
<script>
...
<div class="row">
					...
					<div class="post-social post-social-xs" id="post-social-5">
						<div class="text-center padding-all text-center">
							<div class="textbox text-white   margin-bottom settings-title">
								  <?php _e('Maintenance Page Background Settings','WPSM_MMR_TEXT_DOMAIN'); ?>
							</div>
						</div>
					</div>
				</div>
	...
	<form method="post" id="wpsm_mmr_plugin_options_background" >
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('Select Background','WPSM_MMR_TEXT_DOMAIN'); ?></th>
					...
					<tr class="radio-span" style="border-bottom:none;">
						<td>
							<?php $background_status = $wpsm_mmr_plugin_options_background['select_background']; ?>
		...
		<div class="rcsp_background" id="bg_color" <?php if($background_status!="bg_color"){ ?> style="display:none;" <?php } ?>>
			...
			<div style="margin-bottom: 10px;">
				<img src="<?php echo wpsm_mmr_PLUGIN_URL.'/images/background-color1.png'; ?>" class="img-responsive" style="margin-right: auto;" alt="" >
			</div>
			...
			<div class="panel panel-primary panel-default content-panel">
				<div class="panel-body">
					<table class="form-table">
						<tr>
							<th scope="row" ><?php _e('Background Color','WPSM_MMR_TEXT_DOMAIN'); ?></th>
							<td style="text-align:right;" >
						...
						<tr  style="border-bottom:none;">
							<td>
								<input id="background_color" name="background_color" type="text" value="<?php echo $wpsm_mmr_plugin_options_background['background_color']; ?>" class="my-color-field" data-default-color="#ffffff" />
			...
			<div class="panel panel-primary panel-default content-panel">
				<div class="panel-body">
					<table class="form-table">
						<tr>
							<th scope="row" ><?php _e('Enable Background Effect','WPSM_MMR_TEXT_DOMAIN'); ?></th>
							<td style="text-align:right;" >
						...
						<tr class="radio-span" style="border-bottom:none;">
							...
							<td>
								<?php $bg_effect = $wpsm_mmr_plugin_options_background['bg_effect']; ?>
								<div class="switch">
									...
									<label for="bg_effect" class="switch-label switch-label-off"><?php _e('Yes','WPSM_MMR_TEXT_DOMAIN'); ?></label>
									...
									<label for="bg_effect_off" class="switch-label switch-label-on"><?php _e('No','WPSM_MMR_TEXT_DOMAIN'); ?></label>
			...
			<div class="panel panel-primary panel-default content-panel backg_effect" <?php if($bg_effect != "on") {  ?> style="display:none" <?php } ?>>
				<div class="panel-body">
					<table class="form-table">
						<tr>
							<th scope="row" ><?php _e('Background Effect','WPSM_MMR_TEXT_DOMAIN'); ?></th>
							<td style="text-align:right;" >
						...
						<tr class="radio-span" style="border-bottom:none;">
							...
							<td>
								<?php $bg_cl_overlay = $wpsm_mmr_plugin_options_background['background_color_overlay']; ?>
		...
		<div class="rcsp_background" id="bg_image" <?php if($background_status!="bg_image"){ ?> style="display:none;" <?php } ?>>
			...
			<div style="margin-bottom: 10px;">
				<img src="<?php echo wpsm_mmr_PLUGIN_URL.'/images/background-image.png'; ?>" class="img-responsive"  style="margin-right: auto;" >
			</div>
			...
			<div class="panel panel-primary panel-default content-panel">
				<div class="panel-body">
					<table class="form-table">
						<tr>
							<th scope="row" ><?php _e('Background Image','WPSM_MMR_TEXT_DOMAIN'); ?></th>
							<td style="text-align:right;" >
							...
							<td>
								<div class="col-md-6">
									<div class="rcsp-image-entry" >
										<img src="<?php if($wpsm_mmr_plugin_options_background['background_image']!=''){ echo $wpsm_mmr_plugin_options_background['background_image']; } ?>" />
										<input type="button"  name="upload-background" value="Upload Image Here" class="button-primary rcsp_media_upload"  />
										<input type="text" id="background_image" name="background_image" class="rcsp_label_text"  value="<?php echo $wpsm_mmr_plugin_options_background['background_image']; ?>"  readonly="readonly" placeholder="<?php _e('No Media Selected','WPSM_MMR_TEXT_DOMAIN'); ?>" />
									</div>
								</div>
							</td>
						</tr>
		...
		<div class="rcsp_background" id="bg_slideshow" <?php if($background_status!="bg_slideshow"){ ?> style="display:none;" <?php } ?>>
			...
			<div style="margin-bottom: 10px;">
				<img src="<?php echo wpsm_mmr_PLUGIN_URL.'/images/background-slideshow.png'; ?>" class="img-responsive"  style="margin-right: auto;" >
			</div>
			...
			<div class="panel panel-primary panel-default content-panel">
				<div class="panel-body">
					<table class="form-table">
						<tr>
							<th scope="row" ><?php _e('No. Of Background Slideshow','WPSM_MMR_TEXT_DOMAIN'); ?></th>
							<td style="text-align:right;" >
						...
						<tr  style="border-bottom:none;">
							<td>
								<?php $bg_slideshow_no = $wpsm_mmr_plugin_options_background['bg_slideshow_no']; ?>
			...
			<div class="panel panel-primary panel-default content-panel">
				<div class="panel-body">
					<table class="form-table">
						<tr>
							<th scope="row" ><?php _e('Create Background Sideshow','WPSM_MMR_TEXT_DOMAIN'); ?></th>
							<td style="text-align:right;" >
						...
						<tr  style="border-bottom:none;">
							...
							?>
								<div class="col-md-4 rscp_slides_bg" id="rcsp_sl_bg_<?php echo $i; ?>" style="display:<?php if($bg_slideshow_no=="1"){echo "none";}elseif($i > ($bg_slideshow_no-1)) echo "none";?>" >
									...
									<div class="rcsp-image-entry" >
										<img src="<?php if($wpsm_mmr_plugin_options_background['background_slides_'.$i]!=''){ echo $wpsm_mmr_plugin_options_background['background_slides_'.$i]; } ?>" />
										<input type="button"  name="upload-background" value="Upload Image Here" class="button-primary rcsp_media_upload"  />
										<input type="text" id="background_slides_<?php echo $i; ?>" name="background_slides_<?php echo $i; ?>" class="rcsp_label_text"  value="<?php echo $wpsm_mmr_plugin_options_background['background_slides_'.$i]; ?>"  readonly="readonly" placeholder="<?php _e('No Media Selected','WPSM_MMR_TEXT_DOMAIN'); ?>" value="" />
									</div>
								</div>
							<?php } ?>	
							</td>
						...
						<tr class="radio-span" style="border-bottom:none;">
							<td >
								<h4>Unlock More 5+ background Slideshow In pro version <a href="http://wpshopmart.com/plugins/coming-soon-pro/" target="_blank">Buy Now</a></h4>
							</td>
						</tr>
	...
	<div class="panel panel-primary save-button-block">
		<div class="panel-body">
			...
			<div class="pull-left">
				<button type="button" class="btn btn-info btn-lg" onclick="wpsm_mmr_option_data_save('background')"><?php _e('Save Changes','WPSM_MMR_TEXT_DOMAIN'); ?></button>
			</div>
			<div class="pull-right">
				<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_mmr_option_data_reset('background')"><?php _e('Reset Default','WPSM_MMR_TEXT_DOMAIN'); ?></button>
			</div>
		</div>
	</div>
