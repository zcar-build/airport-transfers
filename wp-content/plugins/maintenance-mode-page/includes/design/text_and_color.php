...
<!----------------------------------------> 
<?php $wpsm_mmr_plugin_options_text_and_color = unserialize(get_option('wpsm_mmr_plugin_options_text_and_color'));	
	?>
<Script>
	...
	jQuery(function() {
		...
		jQuery( "#button-size-slider" ).slider("value",<?php echo $wpsm_mmr_plugin_options_text_and_color['headline_ft_size']; ?>  );
...
<Script>
	...
	jQuery( "#button-size-slider3" ).slider("value",<?php echo $wpsm_mmr_plugin_options_text_and_color['desc_ft_size']; ?> );
...
<div class="row" class="">
					...
					<div class="post-social post-social-xs" id="post-social-5">
						<div class="text-center padding-all text-center">
							<div class="textbox text-white   margin-bottom settings-title">
								 <?php _e('Text And Color Settings','WPSM_MMR_TEXT_DOMAIN'); ?>
							</div>
						</div>
					</div>
				</div>
	...
	<form method="post" id="wpsm_mmr_plugin_options_text_and_color" >
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('Headline Font Colour','WPSM_MMR_TEXT_DOMAIN'); ?></th>
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="headeline_ft_clr" name="headeline_ft_clr" type="text" value="<?php echo $wpsm_mmr_plugin_options_text_and_color['headeline_ft_clr']; ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('Description Font Colour','WPSM_MMR_TEXT_DOMAIN'); ?></th>
						<td style="text-align:right;" >
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="desc_ft_clr" name="desc_ft_clr" type="text" value="<?php echo $wpsm_mmr_plugin_options_text_and_color['desc_ft_clr']; ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('Subscribe Button Font Colour','WPSM_MMR_TEXT_DOMAIN');?></th>
						<td style="text-align:right;" >
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="sb_btn_ft_clr" name="sb_btn_ft_clr" type="text" value="<?php echo $wpsm_mmr_plugin_options_text_and_color['sb_btn_ft_clr']; ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('Countdown Timer Colour','WPSM_MMR_TEXT_DOMAIN'); ?></th>
						<td style="text-align:right;" >
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="cnd_timer_clr" name="cnd_timer_clr" type="text" value="<?php echo $wpsm_mmr_plugin_options_text_and_color['cnd_timer_clr']; ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('Social Icon Font Colour','WPSM_MMR_TEXT_DOMAIN'); ?></th>
						<td style="text-align:right;" >
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="social_icon_clr" name="social_icon_clr" type="text" value="<?php echo $wpsm_mmr_plugin_options_text_and_color['social_icon_clr']; ?>" class="my-color-field" data-default-color="#333333" />
						</td>
					</tr>
				</table>
			</div>
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('Social Icon Background Colour','WPSM_MMR_TEXT_DOMAIN'); ?></th>
						<td style="text-align:right;" >
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="social_icon_bg_clr" name="social_icon_bg_clr" type="text" value="<?php echo $wpsm_mmr_plugin_options_text_and_color['social_icon_bg_clr']; ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('Other Text/Icon Font Color','WPSM_MMR_TEXT_DOMAIN'); ?></th>
						<td style="text-align:right;" >
					...
					<tr  style="border-bottom:none;">
						<td>
							<input id="ext_ft_clr" name="ext_ft_clr" type="text" value="<?php echo $wpsm_mmr_plugin_options_text_and_color['ext_ft_clr']; ?>" class="my-color-field" data-default-color="#ffffff" />
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('All Headlines Font size','WPSM_MMR_TEXT_DOMAIN'); ?></th>
						<td style="text-align:right;" >
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('All Description Font Size','WPSM_MMR_TEXT_DOMAIN'); ?></th>
						<td style="text-align:right;" >
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('All Headlines Font Style','WPSM_MMR_TEXT_DOMAIN'); ?></th>
						<td style="text-align:right;" >
					...
					<?php $headlines_ft_stl =  $wpsm_mmr_plugin_options_text_and_color['headlines_ft_stl']; ?>
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('All Description Font Style','WPSM_MMR_TEXT_DOMAIN'); ?></th>
						<td style="text-align:right;" >
					...
					<?php $desc_ft_stl = $wpsm_mmr_plugin_options_text_and_color['desc_ft_stl']; ?>
					<tr class="" style="border-bottom:none;">
						<td>
		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					<tr>
						<th scope="row" ><?php _e('Other Text Font Style','WPSM_MMR_TEXT_DOMAIN'); ?></th>
						<td style="text-align:right;" >
					...
					<?php $other_ft_stl = $wpsm_mmr_plugin_options_text_and_color['other_ft_stl']; ?>
					<tr class="" style="border-bottom:none;">
						<td>
					...
					<tr class="radio-span" style="border-bottom:none;">
						<td >
							<h4>Unlock More 500+ Google Fonts In pro version <a href="http://wpshopmart.com/plugins/coming-soon-pro/" target="_blank">Try It Now</a></h4>
						</td>
					</tr>
				</table>
			</div>
	...
	<div class="panel panel-primary save-button-block">
		<div class="panel-body">
			<div class="pull-left">
				<button type="button" class="btn btn-info btn-lg" onclick="wpsm_mmr_option_data_save('text_and_color')"><?php _e('Save Changes','WPSM_MMR_TEXT_DOMAIN'); ?></button>
			</div>
			<div class="pull-right">
				<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_mmr_option_data_reset('text_and_color')"><?php _e('Reset Default','WPSM_MMR_TEXT_DOMAIN'); ?></button>
			</div>
		</div>
	</div>
