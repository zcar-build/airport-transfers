...
<style>
		...
		.wpsm_ac_h_i{
			background:url('<?php echo wpsm_mmr_PLUGIN_URL.'img/slideshow-01.jpg'; ?>') 50% 0 repeat fixed;
    ...
    border-color: #000000 !important;
		...
		<div class="wpsm_ac_h_i ">
			<div class="texture-layer">
					...
					<div class="wpsm_ac_h_b"><a class="btn btn-danger btn-lg " href="https://wpshopmart.com/plugins/coming-soon-pro/" target="_blank">Upgrade To Pro Now</a><a class="btn btn-success btn-lg " href="https://wpshopmart.com/coming-soon-pro-demo-page/" target="_blank">View Demo</a></div>
			...
			<a href="https://wpshopmart.com/plugins/coming-soon-pro/" target="_blank"><img src="<?php echo wpsm_mmr_PLUGIN_URL.'images/offer.jpg'; ?>" style="width:100%" /></a>
...
<div id="wrapper">
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		<div class="navbar-header">
			...
			<a class="navbar-brand coming-soon-admin-title" href="#">Maintenance Mode</a>
		</div>
			...
			<div class="sidebar-nav navbar-collapse">
				...
				<ul class="nav " id="side-menu">
					<li class="sidebar-profile text-center">
						...
						<a href="https://wordpress.org/support/plugin/maintenance-mode-page/reviews/?filter=5" target="_new" type="button" class="btn btn-primary btn-lg btn-block rate-us-link" style="" >Rate Us <span class="dashicons dashicons-star-filled"></span>
					...
					<li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
								<a href="#" id="ui-id-7" ><?php _e('Text And Color ','WPSM_MMR_TEXT_DOMAIN'); ?></a>
							</li>
							<li>
								<a href="#" id="ui-id-8" ><?php _e('Custom Css Codes','WPSM_MMR_TEXT_DOMAIN'); ?></a>
							</li>
					...
					<li>
						<a href="#"  id="ui-id-16">
							...
							<span class="sidebar-item-title"><?php _e('Pro Plugin Features','WPSM_MMR_TEXT_DOMAIN'); ?></span>
							<span class="sidebar-item-subtitle"><?php _e('Why purchase pro','WPSM_MMR_TEXT_DOMAIN'); ?></span>
						</a>
					</li>
					<li class="sidebar-profile text-center">
						
						<a href="http://wpshopmart.com/plugins/coming-soon-pro/" target="_blank" class="portfolio_demo_btn2" style="background:#31a3dd!important" >Try Pro Version 
						</a>
	...
	<?php  
	$inc =1;
	$files = array("0"=>array('dashboard','dashboard.php'),"1"=>array('templates','templates.php'),"2"=>array( 'settings','page-settings.php'),"3"=>array('settings','header-settings.php'),"4"=>array('settings','countdown.php'),"5"=>array('design','background.php'),"6"=>array('design','text_and_color.php'),"7"=>array('design','custom_codes.php'),"8"=>array('social','social.php'),"9"=>array('about-us','about-us.php'),"10"=>array('contact-us','contact-us.php'),"11"=>array('newsletter','newsletter.php'),"12"=>array('newsletter','subscription-field.php'),"13"=>array('import-export','import-export.php'),"14"=>array('help','help.php'),"15"=>array('pro','pro.php'));
...
<a title="detail" href="https://wpshopmart.com/plugins/coming-soon-pro/" target="_blank"><img style="width:100%"; class="img-responsive" src="<?php echo wpsm_mmr_PLUGIN_URL.'images/temp.jpg'; ?>" />
			</a>