...
<!----------------------------------------> 	
	...
	<div class="row">
						...
						<div class="post-social post-social-xs" id="post-social-5">
							<div class="text-center padding-all text-center">
								...
								<div class="textbox text-white   margin-bottom settings-title">
									<?php _e('Pro And Free Comparison Table','WPSM_RCS_TEXT_DOMAIN'); ?>
								</div>
		...
		<div style="text-align:center"><a class="portfolio_demo_btn2" href="https://wpshopmart.com/contact/" target="_blank">Pre Sale Query</a></div>
		<br />
		<br />
		
		
		<a title="detail" href="https://wpshopmart.com/plugins/coming-soon-pro/" target="_blank"><img style="width:100%"; class="img-responsive" src="<?php echo wpsm_mmr_PLUGIN_URL.'images/detail.jpg'; ?>" />
			</a>			
		<br />
		<br />
